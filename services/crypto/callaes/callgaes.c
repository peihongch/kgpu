...
#define PLAINTEXT                                                              \
    ("this is a plain text! this is a plain text! this is a plain text! this " \
     "is a plain text! this is a plain text! this is a plain text! this is a " \
     "plain text! this is a plain text! this is a plain text! this is a "      \
     "plain text! this is a plain text! this is a plain text! this is a "      \
     "plain text! this is a plain text! this is a plain text! this is a "      \
     "plain text! this is a plain text! this is a plain text! this is a "      \
     "plain text! this is a plain text! this is a plain text! this is a "      \
...
void test_aes(void) {
    ...
    u8 key[] = {0x00, 0x01, 0x02, 0x03, 0x05, 0x06, 0x07, 0x08,
    ...
    for (bs = MAX_BLK_SIZE; bs >= MIN_BLK_SIZE; bs >>= 1) {
        ...
        printk("%5s: Size %10u, enc BW: %6ld MB/s dec BW: %6ld MB/s\n",
               test_gpu ? "GAES" : "CAES", bs, (bs * TEST_TIMES) / enc,
               (bs * TEST_TIMES) / dec);
    }
